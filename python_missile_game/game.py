...
#게임 이미지 불러오기
background = pygame.image.load("D:\\1학업\\사회복무_법인공인인증서\\Python Workspace\\python game\\background.png")

user = pygame.image.load("D:\\1학업\\사회복무_법인공인인증서\\Python Workspace\\python game\\user.png").convert()
user_size = user.get_rect().size
user_width = user_size[0]
user_height = user_size[1]

enemy = pygame.image.load("D:\\1학업\\사회복무_법인공인인증서\\Python Workspace\\python game\\enemy.png").convert()
